...
def model(i):
    ...
    # Saving
    simConfig.filename = 'PD'  # Set file output name
    ...
    #'E5P','StrD1','StrD2','StrFSI','STN','GPi','GPe'],'orderInverse': True,'timeRange': [100,500], 'figSize': (12,10), 
    #'lw': 0.3,'markerSize':12, 'marker': '.', 'dpi': 500, 'saveFig': 'm1bgt_pd1.png','showFig':False} # Whether or not to plot a raster

    #simConfig.analysis['plotRaster'] = {'include':  ['I23','I23L','E23','I5','I5L','E5A','E5B','E5P','StrD1','StrD2','StrFSI'],'orderInverse': True,'timeRange': [100,1000], 'figSize': (12,10), 'lw': 0.3,'markerSize':12, 'marker': '.', 'dpi': 500, 'saveFig': 'raster.png','syncLines': False} # Whether or not to plot a raster
    ...
    #simConfig.analysis['plotLFP'] = {'includeAxon': True, 'figSize': (6,10), 'timeRange': [100,500], 'saveFig': False,'showFig':True} 
    ...
    netParams.popParams['StrD1'] = {'cellModel': 'StrD1', 'cellType': 'StrD1', 'numCells':100,'yRange': [770, 870]}
    netParams.popParams['StrD2'] = {'cellModel': 'StrD2', 'cellType': 'StrD2', 'numCells': 100,'yRange': [870, 970]}
    netParams.popParams['StrFSI'] = {'cellModel': 'StrFSI', 'cellType': 'StrFSI', 'numCells': 20,'yRange': [970, 1000]}
    netParams.popParams['GPi'] = {'cellModel': 'GPi', 'cellType': 'GPi', 'numCells': 100,'yRange': [1000, 1100]}
    netParams.popParams['GPe'] = {'cellModel': 'GPe', 'cellType': 'GPe',  'numCells': 100,'yRange': [1100, 1200]}
    netParams.popParams['STN'] = {'cellModel': 'STN', 'cellType': 'STN', 'numCells': 100,'yRange': [1200, 1300]}
    netParams.popParams['Th'] = {'cellModel': 'Th', 'cellType': 'Th', 'numCells': 100,'yRange': [1300, 1400]}
    ...
    cellRule['secs']['soma']['geom'] = {'diam': 12.6157,
                                        ...
                                        'Ra': 1,
                                        'nseg': 1}
    cellRule['secs']['soma']['mechs']['Str'] = {'gmbar': (2.6e-3*0.5)}
    ...
    netParams.synMechParams['Glu_AMPA_d1'] = {'mod':'AMPAk','gAmax':3420*recover,'alpha_DA':0.8}
    netParams.synMechParams['Glu_NMDA_d1'] = {'mod':'NMDAk','gNmax':9400*recover1, 'tauon':2.25,'tauoff':150,
    'mg':3.57,'alpha_DA':0.2,'beta_nmda':0.7}
    netParams.synMechParams['Glu_AMPA_d2'] = {'mod':'AMPAk','gAmax':3420*recover,'alpha_DA':0.2,'beta_ampa':-0.8}
    netParams.synMechParams['Glu_NMDA_d2'] = {'mod':'NMDAk','gNmax':9400*recover1, 'tauon':2.25,'tauoff':150,
    ...
    netParams.stimTargetParams['bgS->StrD1'] = {'source': 'background_S', 'conds': {'cellType': ['StrD1']}, 
                                                'synMech': 'AMPA', 'weight': 0.1, 'probability':0.4,'delay': '2+normal(5,3)'}   
    ...
    netParams.connParams['STN->GPe'] = {
        ...
        'probability': 0.3,
        'weight':0.1,  # synaptic weight (conductance)0.007
    ...
    netParams.connParams['GPe->GPe'] = {
        ...
        'probability': 0.5,
        'weight': 0.1,  # synaptic weight (conductance) 0.05+0.75*pd
        'delay': 2,  # transmission delay (ms)
        'loc': 1,  # location of synapse
    ...
    netParams.connParams['StrD2->GPe'] = {
        ...
        'probability': 1,
        'weight': 0.05,  # synaptic weight (conductance) 0.02
    ...
    netParams.connParams['STN->GPi'] = {
        ...
        'probability': 0.6,
        'weight': 0.05,  # synaptic weight (conductance)
    ...
    netParams.connParams['GPe->STN'] = {
        ...
        'probability': 0.6,
        'weight': 0.1,  # synaptic weight (conductance)0.01
    ...
    netParams.connParams['CTX->STN'] = {
        ...
        'probability': 0.2,
        'weight': 0.15,  # synaptic weight (conductance)
        'delay': 2,  # transmission delay (ms)
        'loc': 1,  # location of synapse
    ...
    netParams.connParams['StrD2-> StrD2'] = {
        ...
        'probability': 0.36*0.5,
        'weight': 0.1*0.3,  # synaptic weight (conductance) -> mudar essa maluquisse 0.05e-2
        'delay': 2,  # transmission delay (ms)
        'loc': 1,  # location of synapse
    ...
    netParams.connParams['StrD1-> StrD2'] = {
        ...
        'probability': 0.07*0.3,
        'weight':0.1*0.3 ,  # synaptic weight (conductance) -> mudar aqui tb
        'delay': 2,  # transmission delay (ms)
        'loc': 1,  # location of synapse
        'synMech': 'Igaba_Str'}  # target synaptic mechanism
    ...
    netParams.connParams['StrD2-> StrD1'] = {
        ...
        'probability': 0.27,
        'weight':0.12*0.3 ,  # synaptic weight (conductance) -> mudar aqui tb
        'delay': 2,  # transmission delay (ms)
        'loc': 1,  # location of synapse
        'synMech': 'Igaba_Str'}  # target synaptic mechanism
    ...
    # export the LFP data to a text file
    filename = 'lfp_pdr_'+str(i)+'.txt'
    np.savetxt(filename, lfp_data, delimiter='\t')
    print(matrix)
