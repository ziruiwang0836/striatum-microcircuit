...
#'lw': 0.3,'markerSize':12, 'marker': '.', 'dpi': 500, 'xlabel':[],'ylabel':[],'saveFig': 'm1bgt2.png'} # Whether or not to plot a raster

simConfig.analysis['plotRaster'] = {'include': [ 'I23','I23L','E23','I5','I5L','E5A','E5B','E5P','StrD1','StrD2','StrFSI',
'STN','GPi','GPe'],'orderInverse': True,'timeRange': [500,1000], 'figSize': (12,10), 'legend':True,
'lw': 0,'markerSize':12, 'marker': '.', 'dpi': 500, 'xlabel':'','ylabel':'','saveFig': 'm1bgt_pd_test2.png'} # Whether or not to plot a raster
...
simConfig.analysis['plotLFP'] = {'includeAxon': True, 'figSize': (6,10), 'timeRange': [500,1000], 'saveFig': False,'showFig':True} 
...
netParams.stimTargetParams['bgS->StrD1'] = {'source': 'background_S', 'conds': {'cellType': ['StrD1']}, 
                                            'synMech': 'AMPA', 'weight': 0.1, 'probability':0.2,'delay': '2+normal(5,3)'}   
...
netParams.connParams['GPe->D2'] = {
    ...
    # [ [ idx, (idx+2) % n_neurons ] for idx in range( n_neurons ) ] + \
    # [ [ (idx+1) % n_neurons, idx ] for idx in range( n_neurons ) ],
    'weight': 0.017,  # synaptic weight (conductance)
    'delay': 2,  # transmission delay (ms)
    'loc': 1,  # location of synapse
    'synMech': 'Igestr'}  # target synaptic mechanism
...
netParams.connParams['CTX->STN'] = {
    ...
    'probability': 0.2,
    'weight': 0.2,  # synaptic weight (conductance)
    'delay': 2,  # transmission delay (ms)
    'loc': 1,  # location of synapse
...
netParams.connParams['TH->E23'] = {
    ...
    'probability': 0.2,
    'weight': 0,  # synaptic weight (conductance)
    'delay': 3 , # transmission delay (ms)
    'loc': 1,  # location of synapse
...
netParams.connParams['TH->E5A'] = {
    ...
    'probability': 0.2,
    'weight': 0,  # synaptic weight (conductance)#0.0002
    'delay': 3 , # transmission delay (ms)
    'loc': 1,  # location of synapse
    'synMech': 'Ithco'}  # target synaptic mechanism
...
'probability': 0.2,
'weight': 0,  # synaptic weight (conductance)#0.005
'delay': 3 , # transmission delay (ms)
'loc': 1,  # location of synapse
'synMech': 'Ithco'}  # target synaptic mechanism
