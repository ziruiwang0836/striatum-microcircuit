...
def run(p,id,output_dir):  
    ...
    q = round(p.q,2)
    # Define file names
    name_spk_d1 = f'spk_{p.prefix}_detectors_d1_{id}_q_{q}.pickle'
    name_spk_d2 = f'spk_{p.prefix}_detectors_d2_{id}_q_{q}.pickle'
    name_lfp_d1 = f'lfp_{p.prefix}_detectors_d1_{id}_q_{q}.pickle'
    name_lfp_d2 = f'lfp_{p.prefix}_detectors_d2_{id}_q_{q}.pickle'
